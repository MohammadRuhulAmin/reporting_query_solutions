...
sq4.sdg_indicator,sq4.sequence_en tier_classification,sq1.institution,sq1.activity,sq4.reporting_frequency,sq2.b_year,sq2.data_value_b,
...
WHERE si.index_id = 1 AND sid.language_id = 1  
