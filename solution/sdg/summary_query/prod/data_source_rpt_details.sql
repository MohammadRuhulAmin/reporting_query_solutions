SELECT temp3.agency, temp3.title goal_title, temp3.goal_id,temp3.target_number,temp3.indicator_number,
temp3.data_status data_update_status,temp3.due_data_years due_data,temp3.last_reporting_year,temp4.next_reporting_year FROM(SELECT temp1.*,temp2.* FROM
