...
GROUP_CONCAT(DISTINCT CASE WHEN temp0.data_period IS NULL THEN temp0.next_report_year
WHEN temp0.data_period IS NULL AND temp0.deadline < NOW() THEN temp0.next_report_year
